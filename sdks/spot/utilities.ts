...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("spot");
			params.setVersion("0.1.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3JhY2tlcmxhYnMvc3BvdCIsInZlcnNpb24iOiIwLjEuNCJ9fQ=="), c => c.charCodeAt(0)));
